...
export default function Quote() {
  ...
  function handleSend() {
    const to = 'dispatch@volunteermaterials.com'
    const subject = encodeURIComponent(`New Quote Request — ${form.customer || 'Customer'}`)
    const bodyLines = [
    ...
    <section className="min-h-screen bg-[var(--color-bg)] pt-28 pb-20 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-10">
          ...
          <h1 className="mt-3 text-4xl font-bold">Order Request</h1>
          <p className="mt-2 text-[var(--color-muted)]">
            Fill out the form and we’ll route your request to dispatch.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          <div className="rounded-2xl border border-black/10 bg-white shadow-sm p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium mb-1">Delivery Date Requested</label>
                <input
                  type="date"
                  name="deliveryDate"
              ...
              <div>
                <label className="block text-sm font-medium mb-1">Delivery Time Requested</label>
                <select
                  name="deliveryTime"
            ...
            <p className="mt-3 text-xs text-black/60">
              Submitting opens your email client with the details prefilled to <strong>dispatch@volunteermaterials.com</strong>.
            </p>
          </div>
